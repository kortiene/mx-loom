 ...
 * Claude shim) and the audit arm. They gate themselves on the same env contract as
 * the conformance harness (`MXL_CONFORMANCE_TWO_DAEMON` + `MXL_CONFORMANCE_GOLDEN_POLICY`
 * + fixture coordinates, see `test/_golden-harness.ts`):
