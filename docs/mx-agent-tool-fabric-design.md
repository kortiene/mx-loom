...
| | |
|---|---|
| Status | Active — M0 complete (T001–T008 delivered); M1 in progress — T101–T107 landed (both delegation surfaces: named tools + guarded exec; plus the shared-context publish/fetch seam); see `docs/backlog.md` |
| Date | 2026-06-22 |
